...
# qhasm: q = mem256[q_vector]
# asm 1: vmovdqu q_vector,>q=reg256#1
# asm 2: vmovdqu q_vector,>q=%ymm0
vmovdqu q_vector,%ymm0

# qhasm: qinv = mem256[qinv_vector]
# asm 1: vmovdqu qinv_vector,>qinv=reg256#2
# asm 2: vmovdqu qinv_vector,>qinv=%ymm1
...
.p2align 5
.global _ntt_double512
.global ntt_double512
_ntt_double512:
ntt_double512:
mov %rsp,%r11
and $31,%r11
...
# qhasm: ctrj = 32
# asm 1: mov  $32,>ctrj=int64#4
# asm 2: mov  $32,>ctrj=%rcx
mov  $32,%rcx
...
# qhasm: wp = input_1 + 4096
# asm 1: lea  4096(<input_1=int64#2),>wp=int64#7
# asm 2: lea  4096(<input_1=%rsi),>wp=%rax
lea  4096(%rsi),%rax
...
# qhasm: ctri = 4
# asm 1: mov  $4,>ctri=int64#2
# asm 2: mov  $4,>ctri=%rsi
mov  $4,%rsi
...
# qhasm: mem128[ap +  512] = t1
# asm 1: vmovupd <t1=reg256#5dq,512(<ap=int64#1)
# asm 2: vmovupd <t1=%xmm4,512(<ap=%rdi)
vmovupd %xmm4,512(%rdi)

# qhasm: mem128[ap + 1024] = t2
# asm 1: vmovupd <t2=reg256#6dq,1024(<ap=int64#1)
# asm 2: vmovupd <t2=%xmm5,1024(<ap=%rdi)
vmovupd %xmm5,1024(%rdi)

# qhasm: mem128[ap + 1536] = t3
# asm 1: vmovupd <t3=reg256#3dq,1536(<ap=int64#1)
# asm 2: vmovupd <t3=%xmm2,1536(<ap=%rdi)
vmovupd %xmm2,1536(%rdi)
...
# qhasm: goto loop89j if unsigned>
ja ._loop89j512
...
.p2align 5
.global _pwmul_double1024
.global pwmul_double1024
_pwmul_double1024:
pwmul_double1024:
mov %rsp,%r11
and $31,%r11
...
ret
.p2align 5
.global _pwmul_double512
.global pwmul_double512
_pwmul_double512:
pwmul_double512:
mov %rsp,%r11
and $31,%r11
