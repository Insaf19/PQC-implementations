...
Source codes of the algorithms for "LightSaber", "Saber", "FireSaber" 
  ...
  - These two directories are same.
...
Compilation instruction: 
  - Select the desired algorithm in api.h. This can be done by commenting/uncommenting the appropriate line with #define in the code.   
