...
--------------------------------------------------------------------------------
Authors: Erdem Alkim, Nina Bindel, and Jefferson Ricardini
...
The main function 
"calculate_params()" takes as input "sigma, k, n, eta_e, eta_s, M, kappa, la, prof" and 
...
'sigma', 'la', 'n', 'k', 'eta_e', 'eta_s', 'M', 'kappa', 'h', 'Le', 'Ls', 'E', 'S',  
'q', 'logq', 'B', 'd', 'qs' , 'qh', 'pksize', 'sksize', 'sigsize', 'hardness'.
