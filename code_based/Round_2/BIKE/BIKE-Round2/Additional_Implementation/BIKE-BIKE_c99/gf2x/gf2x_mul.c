...
EXTERNC void gf2_muladd_4x4(OUT uint64_t *res, 
                            IN  const uint64_t *a, 
                            IN  const uint64_t *b);

EXTERNC void karatzuba_add1(OUT const uint64_t *res, 
                            IN const uint64_t  *a, 
                            IN const uint64_t  *b, 
                            IN const uint64_t  n_half, 
                            IN uint64_t  *alah);

EXTERNC void karatzuba_add2(OUT const uint64_t *res,
                            IN  const uint64_t *res1, 
                            IN  const uint64_t *res2, 
                            IN  const uint64_t *tmp, 
                            IN  const uint64_t n_half);

EXTERNC void red_asm(uint64_t *res);
