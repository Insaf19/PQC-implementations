...
#define PARAM_K 7 /**< Parameter k of the scheme (code dimension) */
...
#define VEC_K_BYTES 78 /**< Number of bytes required to store a vector of size k */
#define VEC_N_BYTES 746 /**< Number of bytes required to store a vector of size n */
