...
/*
	...
	#define PARAM_T         										Define a threshold for decoding repetition codeword (PARAM_T = (PARAM_N2 - 1) / 2)
  ...
  #define CIPHERTEXT_BYTES     								Define the size of the ciphertext in bytes
	...
	#define PARAM_K	    												Define the size of the information bits of the BCH code (the size of the informations bits)
	...
	#define UTILS_REJECTION_THREESHOLD   				Define the rejection threshold used to generate given weight vectors 
	...
	#define UTILS_VECTOR_ARRAY_BYTES					  Define the size of the array used to store a PARAM_N sized vector in bytes
																							(number of bytes of UTILS_VECTOR_ARRAY_SIZE)
	...
	#define UTILS_BCH_CODEWORD_ARRAY_SIZE				Size of the array used to store by coordinate a PARAM_N1 sized vector
																							(see vector_u32_init function documentation)
	#define UTILS_MASK_M1       								Define a mask used for extracting the message from a BCH codeword
																							(see get_message_from_codeword function documentation)
	#define UTILS_MASK_M2        								Define a mask used for extracting the message from a BCH codeword
																							(see get_message_from_codeword function documentation)
...
*/
	...
	#define PARAM_N                     				67699
	#define PARAM_N1		 												796
	#define PARAM_N2        										85
	#define PARAM_N1N2      										67660
	#define PARAM_T         										42
  ...
  #define CIPHERTEXT_BYTES    								CRYPTO_CIPHERTEXTBYTES
	...
	#define PARAM_G 														541
	#define PARAM_K	    												256
	#define GENERATOR_POLY     									"DA15FB7C969CE2ACA47F3D5A5C78BD3D13E8B148D5B3949A185B4759B16204323389E0CBF733E1750C22AC589329E66B00B035075BDDBE4C0A0BE70BC9F002B4B07A4208"

	#define UTILS_REJECTION_THREESHOLD   				16721653
	#define UTILS_MASK          								0xFFFFE000
	#define UTILS_MASK_M1       								0x0000000F
	#define UTILS_MASK_M2       								0xFFFFFFF0
	...
	#define UTILS_BCH_CODEWORD_ARRAY_SIZE				25
	#define UTILS_TENSOR_CODEWORD_ARRAY_SIZE 		2115
