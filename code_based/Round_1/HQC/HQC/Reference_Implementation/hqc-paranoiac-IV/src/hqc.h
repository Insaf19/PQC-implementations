...
/**
	...
	*
	* The cihertext is composed of vectors rho and v.
	*
	*
	* \param[out] rho Vector rho (first part of the ciphertext)
...
/**
	...
	* \param[in] rho Vector rho (first part of the ciphertext)
