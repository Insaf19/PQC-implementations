...
*/
  ...
  #define CIPHERTEXT_BYTES     								CRYPTO_CIPHERTEXTBYTES
	...
	#define UTILS_REJECTION_THREESHOLD   				16766561
	...
	#define UTILS_TENSOR_CODEWORD_ARRAY_SIZE 		1269
