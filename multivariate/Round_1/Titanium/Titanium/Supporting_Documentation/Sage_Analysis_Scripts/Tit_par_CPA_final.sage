...
log2SelQsecgoal = log2cat0secmax;
log2SelCsecgoal = log2cat0secClsgt;
...
log2Qsecgoal = R(log2SelQsecgoal + log(6)/log(2)); # add (classical) security reductions factor
log2Csecgoal = R(log2SelCsecgoal + log(6)/log(2)); # add (classical) reduction cost factor
log2DeltaLHLgoal = -R(log2SelCsecgoal + log(6)/log(2)); # add (classical) reduction cost factor
log2pegoal = -30; 
...
log2ScmCsecClaim = -R(log(2*2^(-log2TepsminmC) + 2*2^(log2DeltaLHLAch) + 3*2^(-(256+log2TRO)))/log(2));
...
log2ScmCsecClaim2 = -R(log(2*2^(-log2TepsminmC) + 2*2^(log2DeltaLHLAch))/log(2));
...
log2ScmQsecClaim = -R(log(2*2^(-log2Tepsminm) + 2*2^(log2DeltaLHLAch) + 8*3*Q_d*2^(-(256+log2TQRO)))/log(2));
