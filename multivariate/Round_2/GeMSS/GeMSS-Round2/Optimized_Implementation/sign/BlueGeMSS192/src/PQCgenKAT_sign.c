...
/*  unsigned char       pk[CRYPTO_PUBLICKEYBYTES], sk[CRYPTO_SECRETKEYBYTES];*/
    ...
    PREFIX_NAME(randombytes_init)(entropy_input, NULL, 256);
    for (i=0; i<NB_KATS; i++) {
        fprintf(fp_req, "count = %d\n", i);
        PREFIX_NAME(randombytes)(seed, 48);
        fprintBstr(fp_req, (char*)"seed = ", seed, 48);
        mlen = 33*(i+1);
        fprintf(fp_req, "mlen = %llu\n", mlen);
        PREFIX_NAME(randombytes)(msg, mlen);
    ...
    do {
        ...
        PREFIX_NAME(randombytes_init)(seed, NULL, 256);
        ...
        fprintBstr(fp_rsp, (char*)"pk = ", pk, CRYPTO_PUBLICKEYBYTES);
        fprintBstr(fp_rsp, (char*)"sk = ", sk, CRYPTO_SECRETKEYBYTES);
